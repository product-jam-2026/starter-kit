...
export const COURSE_WELCOME_TEXT =
  "Hey there, and welcome! Read the source code, and navigate to the demos.";
export const COURSE_CREDITS = "Digital Product Jam 2024-2025";
